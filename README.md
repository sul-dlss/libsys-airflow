...
- `AIRFLOW_KEYCLOAK_CLIENT_SECRET` (Login to keycloak-folio-dev, navigate to sul realm, and search for airflow-sso client. Select credentials and copy the client secret for this env var.)
