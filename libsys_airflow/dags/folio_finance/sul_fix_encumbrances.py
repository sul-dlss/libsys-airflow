...
FY_CODE = Variable.get("FISCAL_YEAR_CODE_SUL", "SUL2026")


with DAG(
    "fix_encumbrances_sul",
    default_args=default_args,
    schedule=CronDataIntervalTimetable(
        cron=Variable.get("fix_encumbrances_sul", "00 6 * * MON,WED"),
    ...
    params={
        "choice": Param(
            ...
            minimum=1,
            maximum=9,
            description="The fix_encumbrance script choice. See libsys_airflow/plugins/folio/encumbrances/fix_encumbrances_master.py:1290",
        ),
    },
) as dag:
