...
def trigger_bw_dag(bw_df: pd.DataFrame, user_email: Union[str, None]) -> str:
            ...
            try:
                ...
                if len(bw_df) > 1_000:
                    ...
                    rendered_page = self.render_template(
                        "boundwith/index.html", run_id=run_id, execution_date=execution_date, user_email=email_addr
                    )
