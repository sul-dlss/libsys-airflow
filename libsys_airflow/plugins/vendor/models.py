...
class VendorInterface(Model):
    ...
    folio_data_import_profile_uuid = Column(String(36), unique=True, nullable=False)
    folio_data_import_processing_name = Column(String(50), unique=False, nullable=False)
