...
def hook(mocker):
    ...
    mock_hook.list_directory.return_value = ['3820230411.mrc', '3820230412.mrc', '3820230412.xxx']
    return mock_hook
...
def test_download(hook, download_path):
    ...
    assert hook.retrieve_file.called_with('3820230411.mrc', f"{download_path}/3820230411.mrc")